    ...
    <main className='bg-gray-300 py-10 px-6'>
        ...
        {/* Card 1 */}
          <div className='bg-white shadow-md rounded-lg p-6'>
            <h2 className='text-2xl font-semibold text-black mb-4'>Yang Pertama</h2>
        ...
        {/* Card 2 */}
        <div className='bg-white shadow-md rounded-lg p-6'>
            <h2 className='text-2xl font-semibold text-black mb-4'>Yang Kedua</h2>
              <p className='text-gray-600'>
          ...
          {/* Card 3 */}
          <div className='bg-white shadow-md rounded-lg p-6'>
            <h2 className='text-2xl font-semibold text-black mb-4'>Yang Ketiga</h2>
              <p className='text-gray-600'>
